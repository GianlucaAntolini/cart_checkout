...
namespace YourNamespace.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        CREATE TABLE [OrderProducts] (
            ...
            [Price] [decimal](18, 2) NOT NULL, -- Product price x unit --> at the moment of the order
        ...
        INSERT INTO [PaymentTypes] (Name) VALUES ('Paypal')
             -- Products
        INSERT INTO [Products] (Name, Price, StockQuantity, Active) VALUES ('Product 1', 10.00, 3, 1)
        ...
        INSERT INTO [Coupons] (Code, Active, MinPrice, MaxPrice, PercentageDiscount) VALUES ('COUPON2', 1, 20.00, 100.00, 20.00)
